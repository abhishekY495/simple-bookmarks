    ...
    >
      ...
      {showRemove && (
        <ComboboxPrimitive.ChipRemove
          ...
          className="-ml-1 opacity-50 hover:opacity-100 cursor-pointer bg-yellow-100 text-yellow-700"
          data-slot="combobox-chip-remove"
        >
          <XIcon className="pointer-events-none bg-yellow-100 text-yellow-700" />
        </ComboboxPrimitive.ChipRemove>
      )}
    </ComboboxPrimitive.Chip>
  );
