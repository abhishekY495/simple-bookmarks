...
export function Header() {
  return (
    <nav className="bg-white sticky pt-5 lg:top-0">
      <div className="lg:w-[60%] w-full lg:mx-auto flex items-center lg:justify-between justify-center bg-neutral-100 p-3 px-6 border-2 rounded shadow-lg">
